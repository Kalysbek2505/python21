...
pygame.display.set_caption('Змейка от Калысбек')
...
def Your_score(score):
    value = score_font.render("Твои очки: " + str(score), True, gray)
    dis.blit(value, [235, 0])
...
def gameLoop():
    ...
    while not game_over:
        ...
        while game_close == True:
            dis.fill(blue)
            message("You Lost! Нажни на C-Играть Заново или Q-Выйти из игры", red)
